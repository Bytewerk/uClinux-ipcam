...
#define GRUBEDIT	"/usr/bin/grub-editenv " GRUBENVFILE
...
static void set_bootpart(void)
{
	if (dobootpart == 'a')
		system(GRUBEDIT " set default=0");
	else if (dobootpart == 'b')
		system(GRUBEDIT " set default=1");
}
...
{
	if (dobootpart == 'a')
		system("/bin/fw_setenv bootpart a");
	else if (dobootpart == 'b')
		system("/bin/fw_setenv bootpart b");
}
